...
public class GenericsExempleMap {
	...
	public static void main(String[] args) {
		...
		*/
		...
		Map <String, Integer> mapaGenerics = new HashMap<>(); //o mapa vai conter elementos do tipo String e int
		mapaGenerics.put("Chave 1", 10); //adicionando com put()
		mapaGenerics.put("Chave 2", 20);
		
		//Iterando (percorrendo) sobre  mapa com Generics
